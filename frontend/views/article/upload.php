                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            <div class="form-top-register">
                                <div class="form-top-left-register">
                                    <h3>网文作品提交 | 已经提交？<a href="<?= \yii\helpers\Url::toRoute('article/print') ?>" target="_blank">打印报名表</a></h3>
                                    <p>请按照下列步骤进行填写:</p>
                                </div>
                            </div>
                            <div class="form-bottom">
                                <form role="form" action="<?= Url::toRoute('article/upload')?>" method="post" class="registration-form">
                                    <fieldset>
                                        <div class="form-top">
