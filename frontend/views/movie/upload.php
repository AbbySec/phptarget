                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            <div class="form-top-register">
                                <div class="form-top-left-register">
                                    <h3>微电影作品提交 | 已经提交？<a href="<?= \yii\helpers\Url::toRoute('movie/print') ?>" target="_blank">打印报名表</a></h3>
                                    <p>请按照下列步骤进行填写:</p>
                                </div>
                            </div>
                            <div class="form-bottom">
                                <form role="form" action="<?= Url::toRoute('movie/upload')?>" method="post" class="registration-form">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-bottom">
                                            ...
                                            <div class="register-div2">
                                                ...
                                                <?=Html::activeDropDownList($model, 'works_class2_id', ArrayHelper::map(\backend\models\DisClass2::find()->where(['class1_id'=>'1'])->all(),'id', 'name'),['class'=>'form-control']);?>
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="DisWorksInfo[works_time]" placeholder="时长..." class="form-last-name form-control change" id="form-student-number">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="DisWorksInfo[click_rate]" placeholder="点击率..." class="form-last-name form-control change" id="form-student-number">
                                            </div>
                                        </div>
                                    </fieldset>
