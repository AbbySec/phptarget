                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            <div class="form-top-register">
                                <div class="form-top-left-register">
                                    <h3>网络创新创业大赛报名 | 已经提交？<a href="<?= \yii\helpers\Url::toRoute('entrepreneurship/print') ?>" target="_blank">打印报名表</a></h3>
                                    <p>请按照下列步骤进行填写:</p>
                                </div>
                            </div>
                            <div class="form-bottom">
                                <form role="form" action="<?= Url::toRoute('entrepreneurship/upload')?>" method="post" class="registration-form">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-bottom">
                                            ...
                                            <div class="register-div2">
                                                ...
                                                <?=Html::activeDropDownList($model, 'works_class2_id', ArrayHelper::map(\backend\models\DisClass2::find()->where(['class1_id'=>'10'])->all(),'id', 'name'),['class'=>'form-control']);?>
                                                <div class="form-group">
                                                    <input type="text" name="DisWorksInfo[name]" placeholder="作品形式..." class="form-yourname form-control change" id="yourname">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
