    ...
    <div class="container">
        <div class="top-content">
            <div class="inner-bg">
                <div class="container">
                    <?php
                    if(Yii::$app->session->hasFlash('intuploadsuccess')){
                        echo \yii\bootstrap\Alert::widget([
                            'options' => [
                                'class' => 'bg-primary', //这里是提示框的class
                            ],
                            'body' => Yii::$app->getSession()->getFlash('intuploadsuccess'), //消息体
                        ]);
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
                                <form role="form" action="<?= Url::toRoute('internet/upload')?>" method="post" class="registration-form">
<!--                                    <fieldset>-->
<!--                                        <div class="form-top">-->
...
<!--                                                <label  for="form-your-school">&nbsp&nbsp&nbsp作品名：</label>-->
                                                <input type="hidden" name="DisWorksInfo[name]" placeholder="语言类型" class="form-yourname form-control change" id="yourname" value="nothing"/>
                                            </div>
                                            <label id="movie-lable">报名类别</label>
                                                <?=Html::activeDropDownList($model, 'works_class2_id', ArrayHelper::map(\backend\models\DisClass2::find()->where(['class1_id'=>'8'])->all(),'id', 'name'), ['class'=>"form-control"]);?>
<!--                                            <div class="form-group">-->
