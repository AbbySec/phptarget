...
class Html5Controller extends \yii\web\Controller
{
    ...
    {
        $data = DisWorksInfo::find()->where(['works_class1_id' => '6', 'ispass' => '1'])->limit(16)->asArray()->all();
    ...
    public function actionDetail($id)
    {
        if (is_numeric($id))
        {
            ...
            $work = DisWorksInfo::find()->where(['works_class1_id' => '6'])->asArray()->limit(5)->all();
    ...
    public function actionPrint()
    {
        ...
        if (!$model)
        {
            ...
            return $this->redirect(['html5/upload']);
        }
        $this->layout = false;
    ...
    public function actionUpload()
    {
        ...
        if ($params)
        {
            ...
            $params['DisWorksInfo']['works_class1_id'] = '6';
