...
class MovieController extends \yii\web\Controller
{
    ...
    {
        $data = DisWorksInfo::find()->where(['works_class1_id' => '1', 'ispass' => '1'])->limit(16)->asArray()->all();
    ...
    public function actionDetail($id)
    {
        if (is_numeric($id))
        {
            ...
            $work = DisWorksInfo::find()->where(['works_class1_id' => '1'])->asArray()->limit(5)->all();
    ...
    public function actionPrint()
    {
        ...
        if (!$model)
        {
            ...
            return $this->redirect(['movie/upload']);
        }
        $this->layout = false;
...
//            var_dump(json_encode($stuarr))
            ...
            $params['DisWorksInfo']['works_class1_id'] = '1';
